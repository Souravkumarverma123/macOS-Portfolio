...
const WORK_LOCATION = {
  ...
  children: [
    ...
    {
      id: 5,
      name: "Streamify - A video streaming platform",
      ...
      children: [
        {
          ...
          description: [
            "The streamify website is a sleek and modern platform designed for video streaming and upload your first video online .",
            " Like other video streaming platform who shares your data with third party apps for ads, we give you ad free experience .",
            "we will give the best video streaming expreience, we ensure that  any of your data will not be provided to any third party apps.",
            "It's built with Reactjs, Node js, express and Tailwind, ensuring fast performance, responsive design, and a clean, premium look.",
          ],
        },
        {
          id: 2,
          name: "Streamify.co.in",
    ...
    // ▶ Project 2
    {
      ...
      children: [
        ...
        {
          id: 2,
          name: "Youtube-title-enhancer.com",
          icon: "/images/safari.png",
          kind: "file",
          fileType: "url",
        ...
        {
          id: 4,
          name: "Youtube-title-enhancer.png",
          icon: "/images/image.png",
          kind: "file",
          fileType: "img",
    ...
    // ▶ Project 3
    {
      ...
      children: [
        ...
        },
        {
          ...
          kind: "file",
          fileType: "url",
          href: "https://github.com/Souravkumarverma123",
          position: "top-10 right-20",
        },
        {
          id: 4,
        ...
        },
        {
          ...
          kind: "file",
          fileType: "fig",
          href: "https://www.instagram.com/sourav7534kumar/",
          position: "top-60 right-20",
        },
      ],
    },
...
const ABOUT_LOCATION = {
  ...
  children: [
    ...
    },
    {
      ...
      description: [
        "Hey! I’m Sourav 👋, a web developer who enjoys building sleek, interactive  and scalable websites that actually work well.",
